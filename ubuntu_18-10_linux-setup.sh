...
# mariadb
echo "deb [arch=amd64] http://mirror.netcologne.de/mariadb/repo/10.3/ubuntu cosmic main" > /etc/apt/sources.list.d/mariadb.list
...
#apt install -y nautilus-dropbox enpass spotify-client resilio-sync
